  ...
  public function addWebhooks($webhooks, $formtypes) {
    ...
    public static function formOther($field) {
      ...
      if (isset($field['version']) && $field['version'] === "other") {
        ...
        $html .= '<label class="other-label '.$type.'" for="'.$field['id'].'_Other" onclick="insertOtherTextInput(this)" data-fieldname='.$field['name'].'_Other><input type="'.$type.'" value="Other" id="'.$field['name'].'_Other" name="'.$field['name'].$array.'" data-formtype="'.$field['formtype'].'"'.$extra.'><span class="inline-label">Other</span></label>';
      }
