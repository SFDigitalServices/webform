...
class HTMLHelperTest extends \Codeception\Test\Unit
{
    ...
    **/
    ...
    public function testFormCheckbox(){
        ...
        $this->attributes['formtype'] = 's06';
        $notEmptyCheckBox= HTMLHelper::formCheckbox($this->attributes);
        $expected = '<label for="foo_option_one"><input type="checkbox" id="foo_option_one" value="option one" data-formtype="s08" required class="large rounded"/><span class="inline-label">option one</span></label>';
        $expected .= '<label for="foo_option_one"><input type="checkbox" id="foo_option_two" value="option two" data-formtype="s08" class="large rounded"/><span class="inline-label">option two</span></label>';
        $this->assertEquals($expected, $notEmptyCheckBox);
    }
    ...
    public function testFormFile(){
        ...
        $expected = '<input id="test" type="file" data-formtype="m13"/><label for="test">test</label>';
        ...
        $this->attributes['formtype'] = 'm13';
        $notEmptyFile = HTMLHelper::formFile($this->attributes);
        $expected = '<input id="foo" name="bar" type="file" data-formtype="m13" required class="large rounded"/><label for="foo">test</label>';
        $this->assertEquals($expected, $notEmptyFile);
    }
