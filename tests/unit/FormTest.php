...
class FormTest extends \Codeception\Test\Unit
{
	...
	public function testFormGetHTML()
    {
        ...
        $expected = '<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><div class="form-group field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required/><div class="help-block with-errors"></div><p class="help-text"></p></div></div><div class="form-group field-m14" data-id="submit"><label for="submit" class="control-label"></label><div class="field-wrapper"><button id="submit" data-formtype="m14" class=" btn-primary">Submit</button><div class="help-block with-errors"></div></div></div></fieldset></form>';
        $this->assertEquals($expected, $simpleGetHTML);

        $complexGetHTML = $this->htmlHelper->getHTML($this->complexFormAttributes);
        $expected = '<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><div class="form-group field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required/><div class="help-block with-errors"></div><p class="help-text"></p></div></div><div class="form-group field-s02" data-id="select_dropdown"><label for="select_dropdown" class="control-label">Select - Basic</label><div class="field-wrapper"><select id="select_dropdown" data-formtype="s02" required><option value="">Choose an option</option><option value="Enter">Enter</option><option value="Your">Your</option><option value="Options">Options</option><option value="Here!">Here!</option></select><div class="help-block with-errors"></div></div></div><div class="form-group field-s06" data-id="checkboxId[]"><fieldset><legend class="control-label">Checkboxes</legend><div class="field-wrapper"><label for="checkboxId[]_Option_one"><input type="checkbox" id="checkboxId[]_Option_one" value="Option one" data-formtype="s06" name="checkboxName[]"/><span class="inline-label">Option one</span></label><label for="checkboxId[]_Option_two"><input type="checkbox" id="checkboxId[]_Option_two" value="Option two" data-formtype="s06" name="checkboxName[]"/><span class="inline-label">Option two</span></label><div class="help-block with-errors"></div></div></fieldset></div><div class="form-group field-s08" data-id="multiple_radios"><fieldset><legend class="control-label">Radio buttons</legend><div class="field-wrapper"><label for="multiple_radios_Option_one"><input type="radio" id="multiple_radios_Option_one" value="Option one" data-formtype="s08" name="multiple_radios" required/><span class="inline-label">Option one</span></label><label for="multiple_radios_Option_two"><input type="radio" id="multiple_radios_Option_two" value="Option two" data-formtype="s08" name="multiple_radios" required/><span class="inline-label">Option two</span></label><div class="help-block with-errors"></div></div></fieldset></div><div class="form-group field-m14" data-id="submit"><label for="submit" class="control-label"></label><div class="field-wrapper"><button id="submit" data-formtype="m14" class=" btn-primary">Submit</button><div class="help-block with-errors"></div></div></div></form>';
        $this->assertEquals($expected, $complexGetHTML);

        $sectionalGetHTML = $this->htmlHelper->getHTML($this->sectionalFormAttributes);
        $expected = '<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><div class="sections-container"><div class="form-section-header active">Test Form</div><div class="form-section active"><div class="form-group field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required/><div class="help-block with-errors"></div><p class="help-text"></p></div></div><div class="form-group"><a class="btn btn-lg form-section-prev" href="javascript:void(0)">Previous</a><a class="btn btn-lg form-section-next" href="javascript:void(0)">Next</a></div></div><div class="form-section-header" data-id="page_separator">Page Separator</div><div class="form-section" data-id="page_separator"><div class="form-group field-s08" data-id="address"><fieldset><legend class="control-label">Address</legend><div class="field-wrapper"><label for="address_test"><input type="radio" id="address_test" value="test" data-formtype="s08" name="address" required/><span class="inline-label">test</span></label><div class="help-block with-errors"></div></div></fieldset></div><div class="form-group"><a class="btn btn-lg form-section-prev" href="javascript:void(0)">Previous</a><button id="submit" class="btn btn-lg submit">Submit</button></div></div></div></form>';
