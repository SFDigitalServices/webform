...
class FormTest extends \Codeception\Test\Unit
{
    ...
    private function getExpectedFormHeader($formTitle, $formAction){
      return '<form id="SFDSWFB_forms_" class="form-horizontal" action="'.$formAction.'" method="POST" ><header class="hero-banner default"><div class="form-header-meta"><h2>'.$formTitle.'</h2></div></header>';
	...
	public function testFormWrapJS()
    {
        $emptyWrapJS = $this->htmlHelper->wrapJS($this->emptyFormAttributes);
		    $expected = 'var SFDSWFB = {};SFDSWFB.preRenderScripts = [\'//cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js\', \'///assets/js/validator.js\', \'///assets/js/error-msgs.js\'];SFDSWFB.postRenderScripts = [\'//unpkg.com/libphonenumber-js@1.7.21/bundle/libphonenumber-min.js\'];var script = document.createElement(\'script\'); SFDSWFB.formRender = function() {document.getElementById(\'SFDSWF-Container\').innerHTML = \'<form id="SFDSWFB_forms_" class="form-horizontal" action="" method="POST" ><header class="hero-banner default"><div class="form-header-meta"><h2></h2></div></header></form>\';if (typeof SFDSerrorMsgs != \'undefined\') { SFDSerrorMsgs(); } else { jQuery(\'#SFDSWF-Container form\').validator(); }};script.src = \'///assets/js/embed.js\';var s = document.createElement(\'script\');s.setAttribute(\'type\', \'text/javascript\'); s.text=\'\';document.head.append(s);document.head.appendChild(script);';
        $this->assertSame($expected, $emptyWrapJS);

        $simpleWrapJS = $this->htmlHelper->wrapJS($this->simpleFormAttributes);
        $expected = 'var SFDSWFB = {};SFDSWFB.preRenderScripts = [\'//cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js\', \'///assets/js/validator.js\', \'///assets/js/error-msgs.js\'];SFDSWFB.postRenderScripts = [\'//unpkg.com/libphonenumber-js@1.7.21/bundle/libphonenumber-min.js\'];var script = document.createElement(\'script\'); SFDSWFB.formRender = function() {document.getElementById(\'SFDSWF-Container\').innerHTML = \'<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><header class="hero-banner default"><div class="form-header-meta"><h2>Test Form</h2></div></header><div class="form-group form-group-field field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required aria-invalid="false"/></div><div class="help-block with-errors" id="SFDSWF-name-with-errors"></div></div><div class="form-group form-group-field field-m14" data-id="submit"><label for="submit" class="control-label"></label><div class="field-wrapper"><input type="submit" value="Submit" id="submit" data-formtype="m14" class=" btn-primary"/></div><div class="help-block with-errors" id="SFDSWF-submit-with-errors"></div></div></form>\';if (typeof SFDSerrorMsgs != \'undefined\') { SFDSerrorMsgs(); } else { jQuery(\'#SFDSWF-Container form\').validator(); }};script.src = \'///assets/js/embed.js\';var s = document.createElement(\'script\');s.setAttribute(\'type\', \'text/javascript\'); s.text=\'\';document.head.append(s);document.head.appendChild(script);';
        $this->assertEquals($expected, $simpleWrapJS);

        $complexWrapJS = $this->htmlHelper->wrapJS($this->complexFormAttributes);
        $expected = 'var SFDSWFB = {};SFDSWFB.preRenderScripts = [\'//cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js\', \'///assets/js/validator.js\', \'///assets/js/error-msgs.js\'];SFDSWFB.postRenderScripts = [\'//unpkg.com/libphonenumber-js@1.7.21/bundle/libphonenumber-min.js\'];var script = document.createElement(\'script\'); SFDSWFB.formRender = function() {document.getElementById(\'SFDSWF-Container\').innerHTML = \'<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><header class="hero-banner default"><div class="form-header-meta"><h2>Test Form</h2></div></header><div class="form-group form-group-field field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required aria-invalid="false"/></div><div class="help-block with-errors" id="SFDSWF-name-with-errors"></div></div><div class="form-group form-group-field field-s02" data-id="select_dropdown"><label for="select_dropdown" class="control-label">Select - Basic</label><div class="field-wrapper"><select id="select_dropdown" data-formtype="s02" required aria-invalid="false"><option value="">Choose an option</option><option value="Enter">Enter</option><option value="Your">Your</option><option value="Options">Options</option><option value="Here!">Here!</option></select></div><div class="help-block with-errors" id="SFDSWF-select_dropdown-with-errors"></div></div><div class="form-group form-group-field field-s06" data-id="checkboxId[]"><fieldset><legend class="control-label">Checkboxes <span class="optional">(optional)</span></legend><div class="field-wrapper"><label for="checkboxId[]_Option_one"><input type="checkbox" id="checkboxId[]_Option_one" value="Option one" data-formtype="s06" name="checkboxName[]"/><span class="inline-label">Option one</span></label><label for="checkboxId[]_Option_two"><input type="checkbox" id="checkboxId[]_Option_two" value="Option two" data-formtype="s06" name="checkboxName[]"/><span class="inline-label">Option two</span></label></div><div class="help-block with-errors" id="SFDSWF-checkboxId[]-with-errors"></div></fieldset></div><div class="form-group form-group-field field-s08" data-id="multiple_radios"><fieldset><legend class="control-label">Radio buttons</legend><div class="field-wrapper"><label for="multiple_radios_Option_one"><input type="radio" id="multiple_radios_Option_one" value="Option one" data-formtype="s08" name="multiple_radios" required aria-invalid="false"/><span class="inline-label">Option one</span></label><label for="multiple_radios_Option_two"><input type="radio" id="multiple_radios_Option_two" value="Option two" data-formtype="s08" name="multiple_radios" required aria-invalid="false"/><span class="inline-label">Option two</span></label></div><div class="help-block with-errors" id="SFDSWF-multiple_radios-with-errors"></div></fieldset></div><div class="form-group form-group-field field-m14" data-id="submit"><label for="submit" class="control-label"></label><div class="field-wrapper"><input type="submit" value="Submit" id="submit" data-formtype="m14" class=" btn-primary"/></div><div class="help-block with-errors" id="SFDSWF-submit-with-errors"></div></div></form>\';if (typeof SFDSerrorMsgs != \'undefined\') { SFDSerrorMsgs(); } else { jQuery(\'#SFDSWF-Container form\').validator(); }};script.src = \'///assets/js/embed.js\';var s = document.createElement(\'script\');s.setAttribute(\'type\', \'text/javascript\'); s.text=\'\';document.head.append(s);document.head.appendChild(script);';
        $this->assertEquals($expected, $complexWrapJS);

        $sectionalWrapJS = $this->htmlHelper->wrapJS($this->sectionalFormAttributes);
        $expected = 'var SFDSWFB = {};SFDSWFB.preRenderScripts = [\'//cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js\', \'///assets/js/validator.js\', \'///assets/js/error-msgs.js\'];SFDSWFB.postRenderScripts = [\'//unpkg.com/libphonenumber-js@1.7.21/bundle/libphonenumber-min.js\'];var script = document.createElement(\'script\'); SFDSWFB.formRender = function() {document.getElementById(\'SFDSWF-Container\').innerHTML = \'<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><div class="sections-container"><div class="form-section active"><header class="hero-banner default" id="form_page_1"><div class="form-header-meta"><h2>Test Form</h2><div class="form-progress"><div class="form-progress-bubble">Page 1 of 2</div></div></div><h1 class="form-section-header" data-id="1">Test Form</h1></header><div class="form-content"><div class="form-group form-group-field field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required/></div><div class="help-block with-errors"></div></div><div class="form-group"><button class="btn btn-lg form-section-next">Next</button></div></div></div><div class="form-section" data-id="page_separator"><header class="hero-banner default" id="form_page_2"><div class="form-header-meta"><h2>Test Form</h2><div class="form-progress"><div class="form-progress-bubble">Page 2 of 2</div></div></div><h1 class="form-section-header" data-id="page_separator">Page Separator</h1></header><div class="form-content"><div class="form-group form-group-field field-s08" data-id="address"><fieldset><legend class="control-label">Address</legend><div class="field-wrapper"><label for="address_test"><input type="radio" id="address_test" value="test" data-formtype="s08" name="address" required/><span class="inline-label">test</span></label></div><div class="help-block with-errors"></div></fieldset></div><div class="form-group"><button class="btn btn-lg form-section-prev">Previous</button><button id="preview_submit_page" class="btn btn-lg form-section-next">Next</button></div></div></div><div class="form-section" data-id="page_separator"><header class="hero-banner default"><div class="form-header-meta"><h2>Test Form</h2></div></header><div class="form-content"><div class="form-group"><div id="preview_submitted_data"></div></div><div class="form-group"><button class="btn btn-lg form-section-prev">Previous</button><input type="submit" id="submit" value="Submit" class="btn btn-lg form-section-submit"/></div></div></form>\';if (typeof SFDSerrorMsgs != \'undefined\') { SFDSerrorMsgs(); } else { jQuery(\'#SFDSWF-Container form\').validator(); }initSectional();};script.src = \'///assets/js/embed.js\';var s = document.createElement(\'script\');s.setAttribute(\'type\', \'text/javascript\'); s.text=\'\';document.head.append(s);document.head.appendChild(script);';
        ...
        $expected = 'var SFDSWFB = {};SFDSWFB.preRenderScripts = [\'//cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js\', \'///assets/js/validator.js\', \'///assets/js/error-msgs.js\'];SFDSWFB.postRenderScripts = [\'//unpkg.com/libphonenumber-js@1.7.21/bundle/libphonenumber-min.js\'];var script = document.createElement(\'script\'); SFDSWFB.formRender = function() {document.getElementById(\'SFDSWF-Container\').innerHTML = \'<form id="SFDSWFB_forms_" class="form-horizontal" action="http://somewhere.com/post" method="POST" ><header class="hero-banner default"><div class="form-header-meta"><h2>Test Form</h2></div></header><div class="form-group form-group-field field-c02" data-id="name"><label for="name" class="control-label">Name</label><div class="field-wrapper"><input id="name" data-formtype="c02" name="name" type="text" required aria-invalid="false"/></div><div class="help-block with-errors" id="SFDSWF-name-with-errors"></div></div><div class="form-group form-group-field field-d06" data-id="BAN"><label for="BAN" class="control-label">BAN Number</label><div class="field-wrapper"><input id="BAN" data-formtype="d06" type="number" required name="BAN" aria-invalid="false" step="any"/></div><div class="help-block with-errors" id="SFDSWF-BAN-with-errors"></div></div><div class="form-group form-group-field field-s08" data-id="address"><fieldset><legend class="control-label">Address</legend><div class="field-wrapper"><label for="address_test"><input type="radio" id="address_test" value="test" data-formtype="s08" name="address" required aria-invalid="false"/><span class="inline-label">test</span></label></div><div class="help-block with-errors" id="SFDSWF-address-with-errors"></div></fieldset></div><div class="form-group form-group-field field-m14" data-id="submit"><label for="submit" class="control-label"></label><div class="field-wrapper"><input type="submit" value="Submit" id="submit" data-formtype="m14" class=" btn-primary"/></div><div class="help-block with-errors" id="SFDSWF-submit-with-errors"></div></div></form>\';if (typeof SFDSerrorMsgs != \'undefined\') { SFDSerrorMsgs(); } else { jQuery(\'#SFDSWF-Container form\').validator(); }jQuery(\'#BAN\').on(\'change\',function(){if (jQuery(\'#BAN\').val() != \'\') callWebhook(\'address\', \'http://apps.sfgov.org/bpdev/sites/all/modules/ccsf_api/TTX/BAN.php?type=OOC\', Array(\'BAN\'), \'StreetAddress\', \'json\', false, null, null);});};script.src = \'///assets/js/embed.js\';var s = document.createElement(\'script\');s.setAttribute(\'type\', \'text/javascript\'); s.text=\'\';document.head.append(s);document.head.appendChild(script);';
